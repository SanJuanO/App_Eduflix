...
import UIKit
import Kingfisher
class ForosViewController: UIViewController, UITableViewDataSource, UITableViewDelegate,UISearchBarDelegate {
  var curso=""
 ...
 // navigationController?.setNavigationBarHidden(true, animated: false)
  ...
  //  var arraycursos:[String] = []
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "goforos" {

            let detalle = segue.destination as! DetalleForosViewController
